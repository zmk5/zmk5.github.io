---
layout: blog-post
title: ROS/ROS2 with VSCode
title_sub: Use VSCode to develop your robots!
---
...
### VSCode with ROS and Linux



### VSCode with ROS2 and macOS

I could never really get the original ROS to work with macOS. It always seemed like a bunch of hurdles to jump through, especially if you wanted to use the latest version. ROS2, however, has among its goals to be compatible with [multiple platforms](http://design.ros2.org/articles/why_ros2.html) (Windows, macOS, and Linux). They have a [long road ahead](https://github.com/ros2/ros2/wiki/Roadmap), but they have made some great progress and amazing features.

Binary or Source installation of ROS2 on macOS can be [here](https://github.com/ros2/ros2/wiki/OSX-Install-Binary) and [here](https://github.com/ros2/ros2/wiki/OSX-Development-Setup), respectively.
    ...
    "configurations": [
        {
            ...
            "includePath": [
                "${workspaceFolder}",
                "/Users/zmk5/ros2_install/ros2-osx/include"
            ],
            "defines": [],
            "macFrameworkPath": [
